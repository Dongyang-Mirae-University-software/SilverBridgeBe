...
- **현황(2026-07-15)**: 이상감지 템플릿 `KA01TP260715015020754dXeU0ww3my9` **검수중**. 발신 프로필 `KA01PF240930145539248iUN6bVyplGB`. 승인 전까지 `ALIMTALK_ENABLED=false`(채널 스킵). `pfId`·`templateId`·Solapi 키는 `.env.dev` 주입(평문 커밋 금지).

...
**최종 업데이트**: 2026-09-02 (관리자 대시보드 집계) · 2026-09-01 (이상감지 판정·재촉 / 종류별 허용 채널) · 2026-05-30 (공식 Claude Code 가이드 기준 리팩터링 — 347→~140줄, 도메인 보안 정책을 `.claude/rules/`로 분리) · **Spring Boot** 4.0.5 / **Java** 21 / **빌드** Gradle

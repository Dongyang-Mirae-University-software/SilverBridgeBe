...
public class AuthController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "입력값 유효성 검증 실패 (이메일 형식 오류, 비밀번호 8자 미만 등)"),
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "로그인 성공, Access Token / Refresh Token 반환"),
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "새 Access Token 반환"),
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "마스킹된 이메일 반환"),
            @ApiResponse(responseCode = "400", description = "입력값 유효성 검증 실패"),
            @ApiResponse(responseCode = "404", description = "이름과 전화번호가 일치하는 계정 없음")
    })

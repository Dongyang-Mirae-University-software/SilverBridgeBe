...
|---|---|---|---|---|
| #252 (2026-09-21) | 이상감지 판정 다수결 전환·동수 재확인 안내·관리자 정정 폐지 (V52) | ⚠️ | `(2026-09-21) audit-impact-anomaly-majority-review.md` (템플릿 C) | E-2(동시 응답 상태 덮어쓰기, 기존)·E-3(해제·탈퇴 보호자 표, 기존) 후속 / V52 실 DB 확인 필요(CD 성공, 앱 로그 미확인) - (E-1·B-1 반영 완료) · FE Notion 3페이지 갱신 2026-09-21 |
